...
! When you copy the scripts, please copy from GitHub page, not from this html files!
...
This process takes a while... How about coffee break?
...
Make sure you are in `exp` directory!

```bash
scripts $ cd ../exp
exp $ pwd
/tmp/eagle/work/polyploid-rna-seq-analyses/src/exp
exp $ Rscript ../scripts/plot_homeoroq.R homoeolog_RPKM.txt pval_mean.xls MUR MUR_R48h
exp $
```